...
q3=dataset11[dataset11.isin(q1_2.index)]

anova = ols('Happiness_score~C(year)',q1_2).fit()
...
dataset12[['Age','Dependent_Count','is_Married','Read_Book_per_Year']].corr()
...
q3_ans=0.7894*10 # 회귀계수 * 증가량 왜? 회귀식은 다항 1차 방정식이고 하나의 변수만 변화하기 때문
